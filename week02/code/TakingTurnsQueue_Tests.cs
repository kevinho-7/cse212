...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: 
        //  PersonQueue.Enqueue() inserted items at the front of the list instead of
        // the back, causing the queue to behave like a stack (LIFO) instead of FIFO
    ...
    // Defect(s) Found:
        //  Queue order was incorrect because Enqueue() added items to the front
    ...
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: 
        // People with 0 turns (infinite turns) were not re-added to the queue 
    ...
    // Defect(s) Found: 
        // People with negative turns (infinite turns) were not re-added to the queue.
